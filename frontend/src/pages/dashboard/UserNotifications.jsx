...
import { MdNotifications, MdDoneAll, MdShoppingCart, MdPayment, MdInfo } from 'react-icons/md';
      ...
      <div className="flex items-center justify-between">
        ...
        {unread > 0 && (
          <button onClick={markAllRead}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl gradient-bg text-white text-sm">
        ...
        {loading ? (
          ...
          return (
            <motion.div
              ...
              className={`glass rounded-2xl p-4 cursor-pointer hover:bg-white/5 transition-all ${
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2">
                    <p className={`text-sm font-semibold ${notif.is_read ? 'text-gray-300' : 'text-white'}`}>
                      {notif.title}
                    </p>
