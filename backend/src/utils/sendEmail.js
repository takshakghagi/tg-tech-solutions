...
const sendEmail = async ({ to, subject, html }) => {
  try {
    const { data, error } = await resend.emails.send({
      from:    'TG Tech Solutions <onboarding@resend.dev>',
      to,
      subject,
      html
    });
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:36px 32px;background:#1a1a2e;">
              ...
              <p style="color:#94a3b8;">Your order has been placed! We will contact you shortly.</p>
              <p style="color:#94a3b8;">Order: <strong style="color:#6366f1;">${order.order_number}</strong></p>
        ...
        <table width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:32px;text-align:center;">
              ...
              <p style="margin:8px 0 0;color:rgba(255,255,255,0.9);">Password Reset</p>
            </td>
          </tr>
          <tr>
            <td style="padding:36px 32px;background:#1a1a2e;">
